...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/AppSubscriber.php';
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.response', [#[\Closure(name: 'App\\EventListener\\ResponseListener')] fn () => ($container->privates['App\\EventListener\\ResponseListener'] ??= new \App\EventListener\ResponseListener()), 'onKernelResponse'], 0);
        ...
        $instance->addListener('kernel.response', [#[\Closure(name: 'App\\EventSubscriber\\AppSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\AppSubscriber'] ??= new \App\EventSubscriber\AppSubscriber()), 'onKernelResponse'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\ApiLoginController', 'App\\Controller\\LuckyController', 'App\\Controller\\RegistrationController', 'App\\Controller\\SecurityController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getSecurity_Firewall_MapService($container)
    {
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.main' => ($container->privates['.security.request_matcher.fsrTGnf'] ?? $container->load('get_Security_RequestMatcher_FsrTGnfService'));
