...
class getDebug_Security_Firewall_Authenticator_ApiService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['debug.security.firewall.authenticator.api'] = new \Symfony\Component\Security\Http\Authenticator\Debug\TraceableAuthenticatorManagerListener(new \Symfony\Component\Security\Http\Firewall\AuthenticatorManagerListener(new \Symfony\Component\Security\Http\Authentication\AuthenticatorManager([($container->privates['App\\Security\\ApiKeyAuthenticator'] ?? $container->load('getApiKeyAuthenticatorService')), ($container->privates['security.authenticator.json_login.api'] ?? $container->load('getSecurity_Authenticator_JsonLogin_ApiService')), ($container->privates['security.authenticator.access_token.api'] ?? $container->load('getSecurity_Authenticator_AccessToken_ApiService'))], ($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), ($container->privates['debug.security.event_dispatcher.api'] ?? $container->load('getDebug_Security_EventDispatcher_ApiService')), 'api', ($container->privates['logger'] ?? self::getLoggerService($container)), true, true, [])));
    }
}
