...
class __TwigTemplate_860068caffeec12b2098fd016f4da50d extends Template
{
    ...
    ";
        ...
        // line 14
        yield "
        <button type=\"submit\" class=\"btn\">Зарегаться</button>
    ";
        // line 16
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 16, $this->source); })()), 'form_end');
        yield "
";
    ...
    {
        return array (  108 => 16,  104 => 14,  102 => 12,  98 => 11,  94 => 10,  89 => 8,  85 => 6,  75 => 5,  58 => 3,  41 => 1,);
    }
...
{% endblock %}
", "registration/register.html.twig", "/home/user/intern/TestTaskSecurityAuth/templates/registration/register.html.twig");
    }
}
